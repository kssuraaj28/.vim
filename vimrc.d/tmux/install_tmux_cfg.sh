...
# Generated by vim configuration
...
if [[ -f "$tmux_cfg_file" ]] ; then
    echo "$tmux_cfg_file already exists!"
    echo "tmux support will be incomplete!"
    sleep 2
else
    echo "$tmux_cfg_file does not exist.."
    echo "Creating new $tmux_cfg_file.."
